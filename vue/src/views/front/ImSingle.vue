  ...
  <div>
    <div  class="main-body-content center-container" style="margin-left: 400px;margin-top: 50px;">
      <div style="display: flex; align-items: flex-start">
        <div style="width: 200px; border: 1px solid #000b17; border-radius: 5px; height: calc(50vh + 125px);">
					<div class="header">论坛用户</div>
<!--          学生框-->
					<div class="user-list-box" style="height:calc(50vh + 125px - 39px);overflow-y: scroll;background-color:#eef2f2">
...
export default {
  ...
  mounted() {
    ...
    client = new WebSocket(`ws://localhost:9090/imserverSingle/${id}`)
    client.onopen = () => {
