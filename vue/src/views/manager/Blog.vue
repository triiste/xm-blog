<template>
  <div>
    <div class="search">
      ...
      <el-input placeholder="请输入分类查询" style="width: 200px;margin-right: 10px" v-model="category"></el-input>
      <el-input placeholder="请输入用户名称" style="width: 200px" v-model="username"></el-input>
    ...
    <div class="table">
      <el-table :data="tableData" strip @selection-change="handleSelectionChange">
        ...
        <el-table-column prop="tags" label="标签">
          <template v-slot="scope">
            <el-tag v-for="item in JSON.parse(scope.row.tags || '[]')" :key="item" style="margin-left: 5px">{{ item }}</el-tag>
          </template>
    ...
    load(pageNum) {  // 分页查询
      ...
      this.$request.get('/blog/selectPage', {
        params: {
          ...
          // title是blog对象的一个值,只需要传一个属性即可 能对应上
        }
      }).then(res => {
